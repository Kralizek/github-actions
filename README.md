...
The automated release calculation requires at least one existing stable SemVer tag as its baseline. Stable tags are parsed strictly: numeric components with leading zeroes are ignored.
